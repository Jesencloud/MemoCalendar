...
* **自动化单元测试**：配备 [tests/backup.test.js](tests/backup.test.js)、[tests/date.test.js](tests/date.test.js) 和 [tests/i18n.test.js](tests/i18n.test.js)，覆盖数据解码、字段裁剪、冲突合并、分类去重、日期边界及国际化回退校验。
